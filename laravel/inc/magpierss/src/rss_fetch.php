...
function fetch_rss ($url) {
    ...
    // else cache is ON
        ...
        $cache = new RSSCacheClass( MAGPIE_CACHE_DIR, MAGPIE_CACHE_AGE );
...
function _response_to_rss ($resp) {
    $rss = new MagpieRSSClass( $resp->results, MAGPIE_OUTPUT_ENCODING, MAGPIE_INPUT_ENCODING, MAGPIE_DETECT_ENCODING );
